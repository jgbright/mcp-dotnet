...
internal static class Install
{
    ...
    internal const string ToolCommand = "teams-mcp";

    /// <summary>Default key for the server inside the config's servers object.</summary>
    internal const string DefaultName = "teams";
    ...
    {
        /// <summary>A reference the client resolves at launch, e.g. <c>${TEAMS_MCP_TENANT_ID}</c>.</summary>
        ...
        Client client, IEnumerable<KeyValuePair<string, string>> overrides)
    {
        ...
        Set("TEAMS_MCP_TENANT_ID", client.Ref("TEAMS_MCP_TENANT_ID"));
        Set("TEAMS_MCP_CLIENT_ID", client.Ref("TEAMS_MCP_CLIENT_ID"));
    ...
    internal static int Run(string[] args)
    {
        ...
        var env = EnvEntries(client, options.Set);
